...
/**
 * The Prelims.Project1.BubbleSort class demonstrates the Bubble Sort algorithm for sorting arrays of strings
 ...
 */
 public class BubbleSort {
    ...
    */
     ...
     * @param results A 2D array containing sorting results for different Prelims.Project1.dataset sizes and cases.
     *                Each row corresponds to a Prelims.Project1.dataset size, and columns correspond to best, worst, and average cases.
     */
    public static void displayCounts(long[][] results){
        ...
        */
        ...
        // Display results for each Prelims.Project1.dataset size
