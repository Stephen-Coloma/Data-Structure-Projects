...
public class DatasetGenerator {
    ...
    public static void main(String[] args) {
        ...
        String fileNameAverage = "src/Prelims.Project1.dataset/OneMillion/1M-AverageCase.csv";
        String fileNameBest = "src/Prelims.Project1.dataset/OneMillion/1M-BestCase.csv";
        String fileNameWorst = "src/Prelims.Project1.dataset/OneMillion/1M-WorstCase.csv";
